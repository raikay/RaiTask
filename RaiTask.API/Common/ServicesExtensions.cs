...
using RaiTask.Infrastructure.Filters;
using RaiTask.Infrastructure.Helper;
...
using System.IO;
using RaiTask.API.Attributes;
using RaiTask.API.Filters;
using Microsoft.Extensions.DependencyInjection.Extensions;
using RaiTask.IServices;
using RaiTask.Common.Job;
    ...
    public static class ServicesExtensions
    {
        ...
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.IncludeXmlComments(Path.Combine(basePath, "RaiTask.API.xml"), true);

                options.IncludeXmlComments(Path.Combine(basePath, "RaiTask.Common.xml"), true);

                options.IncludeXmlComments(Path.Combine(basePath, "RaiTask.IServices.xml"));
