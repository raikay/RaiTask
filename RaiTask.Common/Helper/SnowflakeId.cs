...
namespace RaiTask.Infrastructure.Helper
{
    public class SnowflakeId
    {
        ...
        private SnowflakeId() { }
        private static SnowflakeId _SnowflakeId = null;
        ...
        /// </summary>
        /// <returns></returns>
        public static SnowflakeId CreateInstance()
        {
            if (_SnowflakeId == null)
            {
                _SnowflakeId = new SnowflakeId(1,1);
            }
            return _SnowflakeId;
        }
        ...
        public SnowflakeId(long datacenterId = 1, long workerId = 1)
        {
